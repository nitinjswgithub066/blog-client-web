...
export const metadata: Metadata = {
  ...
  description:
    "Learn about VexiraHub — our mission, our team, and the story behind the platform.",
};
      ...
      <div className={styles.container}>
        ...
        <header className={styles.hero}>
          ...
          <p className={styles.heroDesc}>
            VexiraHub is a modern content platform where Technology, AI,
            Startups, Finance, and Culture converge. We believe great writing
            can change how you think — and we are here to deliver it, daily.
          </p>
        </header>
        ...
        <section className={styles.section} aria-labelledby="mission-heading">
          ...
          <p className={styles.sectionText}>
            We bridge the gap between complex ideas and curious readers. Whether
            you&apos;re a developer learning new skills, a founder exploring
            markets, or a student navigating your career — VexiraHub is your
            trusted companion.
          </p>
          ...
          <section className={styles.section} aria-labelledby="creator-heading">
            ...
            <div className={`${styles.creatorCard} ${styles.creatorCardSolo}`}>
              ...
              <div className={styles.teamInfo}>
                ...
                <p className={styles.creatorBio}>{primaryAuthor.bio}</p>
              </div>
            </div>
          </section>
        ) : (
            ...
            {[
              {
                ...
                label: "Twitter",
                href:
                  primaryAuthor.social?.twitter ||
                  "https://twitter.com/vexirahub",
              },
              {
                icon: FiLinkedin,
                label: "LinkedIn",
                href:
                  primaryAuthor.social?.linkedin ||
                  "https://linkedin.com/in/vexirahub",
              },
              {
                icon: FiGithub,
                label: "GitHub",
                href:
                  primaryAuthor.social?.github ||
                  "https://github.com/vexirahub",
              },
              {
                icon: FiMail,
                label: "Email",
                href: "mailto:hello@vexirahub.com",
              },
