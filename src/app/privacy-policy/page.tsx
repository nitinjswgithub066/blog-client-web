...
export const metadata: Metadata = {
  ...
  description:
    "Read VexiraHub's privacy policy — how we collect, use, and protect your data.",
};
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div data-prose className={styles.prose}>
          <p>
            At VexiraHub, we respect your privacy and are committed to
          ...
          <p>
            ...
            subscribe to our newsletter, contact us, or create an account. This
            may include your name, email address, and any message content you
            send us.
          </p>
          ...
          <p>
            ...
            settings or our cookie settings page.
          </p>
